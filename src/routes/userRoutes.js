...
// recuperación:
router.post('/recover/request', userController.requestPasswordReset);
router.post('/recover/verify', userController.verifyPasswordToken);
router.post('/recover/confirm', userController.confirmPasswordReset);
